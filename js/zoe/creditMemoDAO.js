...
function doCreditMemosByCustomerDateRange(tx){
	...
	var sql = "SELECT creditMemo.id_creditMemo, creditMemo.origin, customer.billAddress1, refNumber, txnDate, appliedAmount AS Amount, balanceRemaining AS OpenBalance " +
